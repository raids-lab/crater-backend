...
// 	Idle        corev1.ResourceList      `json:"idle"`
...
// // getNodeRole returns the role of the node based on its labels.
...
// 		// 获取节点类型
// 		vendor := node.Labels["crater.raids.io/nodetype"]
// 		nodeInfos[i] = ClusterNodeInfo{
// 			Name:      node.Name,
// 			Vendor:    vendor, // 添加节点类型
// 			Taints:    taintsToString(node.Spec.Taints),
