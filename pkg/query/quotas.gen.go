...
func newQuota(db *gorm.DB, opts ...gen.DOOption) quota {
	...
	_quota.ID = field.NewInt64(tableName, "id")
	_quota.CreatedAt = field.NewTime(tableName, "created_at")
	_quota.UpdatedAt = field.NewTime(tableName, "updated_at")
	_quota.Username = field.NewString(tableName, "username")
	_quota.Namespace = field.NewString(tableName, "namespace")
	_quota.HardQuota = field.NewString(tableName, "hardQuota")
...
func (q *quota) updateTableName(table string) *quota {
	...
	q.Namespace = field.NewString(table, "namespace")
	q.HardQuota = field.NewString(table, "hardQuota")
...
func (q *quota) fillFieldMap() {
	...
	q.fieldMap["namespace"] = q.Namespace
	q.fieldMap["hardQuota"] = q.HardQuota
}
