...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ChangeImagePublicStatusRequest"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateKanikoRequest"
                        }
                    }
                ],
                "responses": {}
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateResoueceReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/aijobs/training": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create AI Job Request",
                        "name": "job",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Create AI Job Response",
                        "schema": {
                            "$ref": "#/definitions/resputil.Response-any"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.RenameReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateByDockerfileRequest"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UploadImageRequest"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateProjectQuotaRequest"
                        }
                    }
                ],
                "responses": {}
        ...
        "/v1/labels": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "label struct",
                        "schema": {
                            "$ref": "#/definitions/resputil.Response-handler_LabelResp"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功返回值",
                        "schema": {
                            "$ref": "#/definitions/resputil.Response-payload_ClusterNodeDetail"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
    ...
    "definitions": {
        ...
        "handler.ChangeImagePublicStatusRequest": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "handler.CreateByDockerfileRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "handler.UpdateProjectQuotaRequest": {
            "type": "object",
            "required": [
                "size"
            ],
        ...
        "resputil.Response-handler_LabelResp": {
            "type": "object",
            "properties": {
                "code": {
                    "$ref": "#/definitions/resputil.ErrorCode"
        ...
        "resputil.Response-payload_ClusterNodeDetail": {
            "type": "object",
            "properties": {
                "code": {
                    "$ref": "#/definitions/resputil.ErrorCode"
                ...
                "data": {
                    "$ref": "#/definitions/payload.ClusterNodeDetail"
                },
                "msg": {
                    "type": "string"
                }
